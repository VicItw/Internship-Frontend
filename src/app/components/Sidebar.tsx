      ...
      >
        <Box bgcolor="white" width="270px" padding="10px" height="700px">
          ...
          <Stack
            direction="row"
            spacing={4}
            sx={{ display: open ? "flex" : "none", mb: "30px", mt: "10px" }}
          >
            <Typography variant="h6" color="#109CF1">
              Athena Back Office
            </Typography>
          ...
          <Stack direction="column" spacing={2} margin={0.6} mt={2}>
            ...
            <Stack direction="row">
              <Tooltip
                title={open ? null : "Use Case Management"}
                placement="right"
                arrow
              >
            ...
            <Stack direction="row">
              <Tooltip
                title={open ? null : "Data Preparation"}
                placement="right"
                arrow
              >
            ...
            <Stack direction="row">
              <Tooltip
                title={open ? null : "Teachable Tool"}
                placement="right"
                arrow
              >
